...
const info = `
<div class="info-grid">
<span class="label">USER</span><span class="value">${config.user}</span>
<span class="label">OS</span><span class="value">${config.distro}</span>
<span class="label">KERNEL</span><span class="value">${config.kernel}</span>
<span class="label">UPTIME</span><span class="value">${config.uptime}</span>
<span class="label">SHELL</span><span class="value">${config.shell}</span>
<span class="label">INTERESTS</span><span class="value">${config.interests}</span>
</div>
`;

const div = document.createElement('div');
div.className = 'fastfetch';
div.innerHTML = `<pre class="ascii">${logo}</pre>${info}`;
